...
class ProfileService:
    ...
    def create_profile(self, name: str, description: str = None, csv_format: str = None) -> ProfileOut:
        ...
        try:
            ...
            self._logger.info("Profile created successfully", profile_id=profile.id, name=profile.name)
            return profile
    ...
    def delete_profile(self, profile_id: int, force: bool = False) -> bool:
        ...
        try:
            ...
            if result:
                if force:
                    self._logger.warning("Profile and associated trades deleted", profile_id=profile_id)
                else:
    ...
    def delete_profile_data(self, profile_id: int) -> dict:
        ...
        self._logger.warning("Deleting all data for profile", profile_id=profile_id, name=profile.name)
