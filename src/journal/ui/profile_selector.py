...
from .profile_dialog import ProfileSelectionDialog, ProfileManagerDialog
...
class ProfileSelectorWidget(QWidget):
    ...
    def get_current_profile(self) -> Optional[ProfileOut]:
    ...
    def show_profile_selection_dialog(self) -> Optional[int]:
